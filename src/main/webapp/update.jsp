...
<nav class="navbar bg-dark border-bottom border-body" data-bs-theme="dark">
		<div class="container">
    		...
    		<a class="btn btn-outline-secondary me-2" href="CreateAndFind">Lista de Usuarios</a>
	...
	<div class="container">
		...
		<input type="hidden" name="id" value="${cliente.id}">
			...
			<div class="mb-3">
	  			...
	  			<input class="form-control" type="date" name="dataNascimento" id="nascimento" value="${cliente.dataNascimento}"></input>
			</div>
			<div class="mb-3">
	  			<label for="login" class="form-label">Login</label>
	  			<input class="form-control" type="text" name="login" id="login" value="${cliente.login}">
			</div>
			<div class="mb-3">
	  			<label for="senha" class="form-label">Senha</label>
	  			<input class="form-control" type="text" name="senha" id="senha"></input>
			</div>
