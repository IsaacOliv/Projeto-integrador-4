		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item"><a class="nav-link"
						href="lista-carros-interessados">Carros com interessados</a></li>
	...
	<div class="container mt-4">
		<div class="row">
			<div class="col-md-7">
				...
				<a href=gerar-relatorio class="btn btn-primary">Relatorio</a>
				<hr>
				<table class="table">
					<thead>
						<tr>
								...
								<td>
									<div class="row">
										<a class="btn btn-primary mt-2"
											href="CarroVizualizarInteresse?carroId=${ carro.id }">Vizualizar</a>
									</div>
								</td>
							</tr>
						</c:forEach>
